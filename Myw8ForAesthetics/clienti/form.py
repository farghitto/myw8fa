...
class FormMisure(forms.Form):
    ...
    peso = forms.FloatField(label='Peso:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'peso'}),
    ...
    grasso_corporeo = forms.FloatField(label='grasso_corporeo:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'grasso_corporeo'}))
    muscolatura = forms.FloatField(label='muscolatura:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'muscolatura'}))
    metabolismo = forms.FloatField(label='metabolismo:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'metabolismo'}))
    grasso_viscerale = forms.FloatField(label='grasso_viscerale:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'grasso_viscerale'}))
    collocm = forms.FloatField(label='cm collo:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'collocm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    toracecm = forms.FloatField(label='cm torace:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'toracecm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    cosciadxcm = forms.FloatField(label='cm coscia destra:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'cosciadxcm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    cosciasxcm = forms.FloatField(label='cm coscia sinistra:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'cosciasxcm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    fianchicm = forms.FloatField(label='cm fianchi:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'fianchicm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    addomecm = forms.FloatField(label='cm addome:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'addomecm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    ginocchiodxcm = forms.FloatField(label='cm ginocchio destra:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'ginocchiodxcm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    ginocchiosxcm = forms.FloatField(label='cm ginocchio sinistra:', 
                            widget = forms.NumberInput(attrs={'class': 'form-control font-custom', 'placeholder': 'ginocchiosxcm'}),
                            error_messages= {'required': 'la misura è obbligatoria.'})
    peso_ottimale = forms.CharField( max_length=100, label='Peso ottimale:', 
                               widget=forms.TextInput(attrs={'class': 'form-control font-custom', 'placeholder': 'peso_ottimale'}))
    peso_desiderato = forms.CharField( max_length=100, label='Peso desiderato:', 
                               widget=forms.TextInput(attrs={'class': 'form-control font-custom', 'placeholder': 'peso_desiderato'}))
