...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://*.myw8.it','https://*.127.0.0.1']
...
BASE_URL = 'http://192.168.76.210:8010/'
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static-serve')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Esempio: cartella 'static' nella directory del tuo progetto
    # Altre directory relative al tuo progetto
]
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(BASE_DIR, 'log', 'debug.log'),  # Percorso completo del file di log
        },
    },
    'loggers': {
        'django': {
