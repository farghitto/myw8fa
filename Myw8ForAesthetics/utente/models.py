...
class Anagrafica(models.Model):
    ...
    affiliatore = models.ForeignKey("self", on_delete=models.SET("senza superiore"),null=True,blank=True, related_name='affiliati_anagrafica')
    seguito = models.ForeignKey("self", on_delete=models.SET("senza superiore"),null=True,blank=True, related_name='seguito_anagrafica')

    """ Struttura """
    # tipo_struttura = models.ForeignKey(Struttura,on_delete=models.SET_NULL,null=True,blank=True)
    id_superiore = models.ForeignKey("self", on_delete=models.SET("senza superiore"),null=True,blank=True, related_name='superiore_anagrafica')
